...
const agrandir = localFont({
  src: [
    {
      path: '../../public/Agrandir-Regular.otf',
      weight: '400'
    },
    {
      path: '../../public/Agrandir-TextBold.otf',
      weight: '700'
    }
  ],
...
export default async function RootLayout({
  ...
  return (
    <html lang={lng} dir={dir(lng)}>
      <body className={`${ibm_plex_mono.className} ${agrandir.variable} bg-dojo-blue text-dojo-blue-400`}>
        <TopNav lng={lng} />
        {children}
        <Background />
        <Footer />
